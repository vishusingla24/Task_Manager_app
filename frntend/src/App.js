...
import ForgotPass from "./components/ForgotPass";
import ResetPass from "./components/ResetPass";
import TaskStatus from "./components/ChartPage"; // Import Task Completion Chart Page
import { useState } from "react";
      ...
      <Routes>
        ...
        <Route path="/Home" element={<Home tasks={tasks} />}>
          ...
          <Route
            ...
            element={<Task toast={toast} tasks={tasks} setTasks={setTasks} />}
          />
          {/* ✅ New Route for Task Completion Chart */}
          <Route
            path="/Home/task-status"
            element={<TaskStatus tasks={tasks} />}
          />
        </Route>
      </Routes>
    </BrowserRouter>
